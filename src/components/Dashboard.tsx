...
const Dashboard = () => {
  const [currentlyDeleting, setCurrentlyDeleting] = React.useState<
    string | null
  >(null);
  ...
  return (
    <main className="mx-auto max-w-7xl ">
      <div className="mt-8 flex flex-col items-start justify-between gap-4 border-b border-gray-200 pb-5 sm:flex-row sm:items-center sm:gap-0">
        <h1 className="mb-4 font-bold text-5xl text-gray-900">My Files</h1>
      ...
      {files && files?.length !== 0 ? (
                  ...
                  <div className="pt-6  px-6 flex w-full items-center justify-between space-x-6 ">
                    ...
                    <div className="flex-1 truncate">
                      <div className="flex items-center space-x-3 ">
                        <h3 className="truncate text-lg dont-medium text-zinc-900">
                          {file.name}
                        </h3>
                      </div>
                    </div>
        ...
        <Skeleton height={100} className="my-2 mx-3" count={3} />
      ) : (
